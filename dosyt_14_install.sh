...
sudo -H pip3 install -r https://raw.githubusercontent.com/chakerouari/dosyt-14.0/master/requirements.txt
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/chakerouari/dosyt-14.0 $OE_HOME_EXT/
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    GITHUB_RESPONSE=$(sudo git clone --depth 1 --branch $OE_VERSION https://github.com/chakerouari/dosyt14_ent_unlimit "$OE_HOME/enterprise/addons" 2>&1)
